...
export const metadata: Metadata = {
  title: "Studio",
  description: `${SITE.name} — who we are and what we're building.`,
};
...
const STATS = [
  ...
  { n: `${new Date().getFullYear() - SITE.founded}`, l: "Years running" },
        ...
        <div className="gap-14 md:gap-20">
          <Reveal className="max-w-[92vw] mx-auto">
            <p className="font-heading text-(length:--text-title) leading-normal text-paper text-center">
              We started Cavern in {SITE.founded}{" "} with one rule: make the kind
            ...
            <p className="mt-6 text-lg md:text-2xl leading-relaxed text-sage">
              ...
              {SITE.location.split(" · ")[0]}. We build atmospheric worlds —
