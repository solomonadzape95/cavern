...
export const metadata: Metadata = {
  title: "Press Kit",
  description: `Facts, assets, and contacts for press covering ${SITE.name}.`,
};
...
const FACTS: { k: string; v: string }[] = [
  ...
  { k: "Press contact", v: SITE.pressEmail },
];
        ...
        <div className="grid gap-14 md:grid-cols-[1fr_1fr] md:gap-20">
          ...
          <Reveal>
            ...
            <p className="mt-4 max-w-[60ch] leading-relaxed text-paper/90">
              {SITE.name} is a small, remote-first game studio founded in{" "}
              {SITE.founded}, making atmospheric, hand-made games with rough
